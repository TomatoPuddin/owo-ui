...
import static io.wispforest.owoui.ops.TextOps.withColor;
...
public class Owo implements ModInitializer {
    ...
    public static final Logger LOGGER = LogManager.getLogger("owoui");
    ...
    static {
        ...
        if (System.getProperty("owoui.debug") != null) debug = Boolean.getBoolean("owoui.debug");
        if (Boolean.getBoolean("owoui.forceDisableDebug")) {
            LOGGER.warn("Deprecated system property 'owoui.forceDisableDebug=true' was used - use 'owoui.debug=false' instead");
            debug = false;
        }
