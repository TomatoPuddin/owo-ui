...
import io.wispforest.owoui.mixin.shader.ShaderProgramAccessor;
...
public class GlProgram {
        ...
        REGISTERED_PROGRAMS.add(new Pair<>(
                resourceFactory -> {
                    try {
                        ...
                        throw new RuntimeException("Failed to initialized owoui shader program", e);
                    }
                },
                program -> {
    ...
    protected @Nullable GlUniform findUniform(String name) {
        return ((ShaderProgramAccessor) this.backingProgram).owoui$getLoadedUniforms().get(name);
    }
