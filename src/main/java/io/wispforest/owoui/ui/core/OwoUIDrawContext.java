...
import io.wispforest.owoui.client.OwoClient;
import io.wispforest.owoui.mixin.ui.DrawContextInvoker;
import io.wispforest.owoui.ui.event.WindowResizeCallback;
...
public class OwoUIDrawContext extends DrawContext {
    ...
    @Deprecated
    public static final Identifier PANEL_TEXTURE = new Identifier("owoui", "textures/gui/panel.png");
    @Deprecated
    public static final Identifier DARK_PANEL_TEXTURE = new Identifier("owoui", "textures/gui/dark_panel.png");
    @Deprecated
    public static final Identifier PANEL_INSET_TEXTURE = new Identifier("owoui", "textures/gui/panel_inset.png");

    public static final Identifier PANEL_NINE_PATCH_TEXTURE = new Identifier("owoui", "panel/default");
    public static final Identifier DARK_PANEL_NINE_PATCH_TEXTURE = new Identifier("owoui", "panel/dark");
    public static final Identifier PANEL_INSET_NINE_PATCH_TEXTURE = new Identifier("owoui", "panel/inset");
    ...
    public static OwoUIDrawContext of(DrawContext context) {
        ...
        ((DrawContextInvoker) owoContext).owoui$setScissorStack(((DrawContextInvoker) context).owoui$getScissorStack());
        ((DrawContextInvoker) owoContext).owoui$setMatrices(((DrawContextInvoker) context).owoui$getMatrices());
    ...
    public void drawTooltip(TextRenderer textRenderer, int x, int y, List<TooltipComponent> components) {
        ((DrawContextInvoker) this).owoui$renderTooltipFromComponents(textRenderer, components, x, y, HoveredTooltipPositioner.INSTANCE);
    }
