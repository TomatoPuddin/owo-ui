...
public class EntityComponent<E extends Entity> extends BaseComponent {
    ...
    public void draw(OwoUIDrawContext context, int mouseX, int mouseY, float partialTicks, float delta) {
        ...
        dispatcher.owoui$setCounterRotate(true);
        dispatcher.owoui$setShowNametag(this.showNametag);
        ...
        dispatcher.owoui$setCounterRotate(false);
        dispatcher.owoui$setShowNametag(true);
    }
