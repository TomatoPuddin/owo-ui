...
import io.wispforest.owoui.mixin.ui.access.ButtonWidgetAccessor;
import io.wispforest.owoui.mixin.ui.access.ClickableWidgetAccessor;
import io.wispforest.owoui.ui.core.Color;
...
public class ButtonComponent extends ButtonWidget {
    ...
    public static final Identifier ACTIVE_TEXTURE = new Identifier("owoui", "button/active");
    public static final Identifier HOVERED_TEXTURE = new Identifier("owoui", "button/hovered");
    public static final Identifier DISABLED_TEXTURE = new Identifier("owoui", "button/disabled");
    ...
    public void renderButton(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        var tooltip = ((ClickableWidgetAccessor) this).owoui$getTooltip();
    ...
    public ButtonComponent onPress(Consumer<ButtonComponent> onPress) {
        ((ButtonWidgetAccessor) this).owoui$setOnPress(button -> onPress.accept((ButtonComponent) button));
        return this;
    }
