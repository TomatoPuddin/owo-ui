...
public class VanillaWidgetComponent extends BaseComponent {
    ...
    protected int determineVerticalContentSize(Sizing sizing) {
        if (this.widget instanceof ButtonWidget || this.widget instanceof CheckboxWidget || this.widget instanceof SliderComponent) {
            ...
            if (((TextFieldWidgetAccessor) textField).owoui$drawsBackground()) {
                return 20;
            } else {
                return 9;
            }
    ...
    private void applyToWidget() {
        ...
        accessor.owoui$setX(this.x + this.widget.xOffset());
        accessor.owoui$setY(this.y + this.widget.yOffset());

        accessor.owoui$setWidth(this.width + this.widget.widthOffset());
        accessor.owoui$setHeight(this.height + this.widget.heightOffset());
    }
