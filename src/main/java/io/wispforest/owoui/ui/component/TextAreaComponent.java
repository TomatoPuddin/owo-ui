...
import io.wispforest.owoui.mixin.ui.access.EditBoxAccessor;
import io.wispforest.owoui.mixin.ui.access.EditBoxWidgetAccessor;
import io.wispforest.owoui.ui.core.CursorStyle;
import io.wispforest.owoui.ui.core.Size;
...
public class TextAreaComponent extends EditBoxWidget {
    ...
    protected TextAreaComponent(Sizing horizontalSizing, Sizing verticalSizing) {
        ...
        this.editBox = ((EditBoxWidgetAccessor) this).owoui$getEditBox();
    ...
    public void inflate(Size space) {
        ...
        int selection = ((EditBoxAccessor) this.editBox).owoui$getSelectionEnd();

        ((EditBoxAccessor) this.editBox).owoui$setWidth(this.width() - this.getPaddingDoubled() - 9);
        ...
        ((EditBoxAccessor) this.editBox).owoui$setSelectionEnd(selection);
    }
