...
public class SlimSliderComponent extends BaseComponent {
    ...
    protected static final Identifier TEXTURE = new Identifier("owoui", "textures/gui/slim_slider.png");
    protected static final Identifier TRACK_TEXTURE = new Identifier("owoui", "slim_slider_track");
