...
public final class Layers {
     ...
     */
    public static final Identifier INIT_PHASE = new Identifier("owoui", "init-layers");
    ...
    public static <S extends Screen> List<Layer<S, ?>.Instance> getInstances(S screen) {
        return (List<Layer<S, ?>.Instance>) (Object) ((OwoScreenExtension) screen).owoui$getInstancesView();
    }
    ...
    static {
        ...
        ScreenEvents.AFTER_INIT.register(INIT_PHASE, (client, screeen, scaledWidth, scaledHeight) -> {
            ((OwoScreenExtension) screeen).owoui$updateLayers();
