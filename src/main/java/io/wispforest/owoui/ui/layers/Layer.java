package io.wispforest.owoui.ui.layers;

import io.wispforest.owoui.mixin.ui.layers.HandledScreenAccessor;
...
public class Layer<S extends Screen, R extends ParentComponent> {
    ...
    public Instance getInstance(S screen) {
        return ((OwoScreenExtension) screen).owoui$getInstance(this);
    }
        ...
        public void alignComponentToHandledScreenCoordinates(Component component, int x, int y) {
            ...
            this.layoutUpdaters.add(() -> {
                component.positioning(Positioning.absolute(
                        ((HandledScreenAccessor) handledScreen).owoui$getRootX() + x,
                        ((HandledScreenAccessor) handledScreen).owoui$getRootY() + y
                ));
            });
        }
