package io.wispforest.owoui.ui.container;

import io.wispforest.owoui.ui.core.*;
import io.wispforest.owoui.ui.parsing.UIModel;
import io.wispforest.owoui.ui.parsing.UIModelParsingException;
import io.wispforest.owoui.ui.parsing.UIParsing;
import io.wispforest.owoui.ui.util.Delta;
...
public class ScrollContainer<C extends Component> extends WrappingParentComponent<C> {
    ...
    public static final Identifier VERTICAL_VANILLA_SCROLLBAR_TEXTURE = new Identifier("owoui", "scrollbar/vanilla_vertical");
    public static final Identifier DISABLED_VERTICAL_VANILLA_SCROLLBAR_TEXTURE = new Identifier("owoui", "scrollbar/vanilla_vertical_disabled");
    public static final Identifier HORIZONTAL_VANILLA_SCROLLBAR_TEXTURE = new Identifier("owoui", "scrollbar/vanilla_horizontal_disabled");
    public static final Identifier DISABLED_HORIZONTAL_VANILLA_SCROLLBAR_TEXTURE = new Identifier("owoui", "scrollbar/vanilla_horizontal_disabled");
    public static final Identifier VANILLA_SCROLLBAR_TRACK_TEXTURE = new Identifier("owoui", "scrollbar/track");
    public static final Identifier FLAT_VANILLA_SCROLLBAR_TEXTURE = new Identifier("owoui", "scrollbar/vanilla_flat");
