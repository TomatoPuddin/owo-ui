package io.wispforest.owoui.ui.base;

import io.wispforest.owoui.Owo;
import io.wispforest.owoui.mixin.ui.SlotAccessor;
import io.wispforest.owoui.ui.core.*;
import io.wispforest.owoui.ui.inject.GreedyInputComponent;
import io.wispforest.owoui.ui.util.DisposableScreen;
import io.wispforest.owoui.ui.util.UIErrorToast;
...
public abstract class BaseOwoHandledScreen<R extends ParentComponent, S extends ScreenHandler> extends HandledScreen<S> implements DisposableScreen {
    ...
    protected void init() {
        ...
        if (this.uiAdapter != null) {
            ...
            try {
                ...
                Owo.LOGGER.warn("Could not initialize owoui screen", error);
    ...
    protected void disableSlot(int index) {
        ((OwoSlotExtension) this.handler.slots.get(index)).owoui$setDisabledOverride(true);
    }
    ...
    protected void disableSlot(Slot slot) {
        ((OwoSlotExtension) slot).owoui$setDisabledOverride(true);
    }
    ...
    protected void enableSlot(int index) {
        ((OwoSlotExtension) this.handler.slots.get(index)).owoui$setDisabledOverride(false);
    }
    ...
    protected boolean isSlotEnabled(int index) {
        return ((OwoSlotExtension) this.handler.slots.get(index)).owoui$getDisabledOverride();
    }

    protected boolean isSlotEnabled(Slot slot) {
        return ((OwoSlotExtension) slot).owoui$getDisabledOverride();
    }
    ...
    public class SlotComponent extends BaseComponent {
        ...
        public void draw(OwoUIDrawContext context, int mouseX, int mouseY, float partialTicks, float delta) {
            ...
            ((OwoSlotExtension) this.slot).owoui$setScissorArea(PositionedRectangle.of(
        ...
        public void update(float delta, int mouseX, int mouseY) {
            ...
            ((OwoSlotExtension) this.slot).owoui$setDisabledOverride(!this.didDraw);
        ...
        public void updateX(int x) {
            super.updateX(x);
            ((SlotAccessor) this.slot).owoui$setX(x - BaseOwoHandledScreen.this.x);
        }

        @Override
        public void updateY(int y) {
            super.updateY(y);
            ((SlotAccessor) this.slot).owoui$setY(y - BaseOwoHandledScreen.this.y);
        }
    }
}
